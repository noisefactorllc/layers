        ...
        this._dialog.innerHTML = `
            ...
            <div class="welcome-tiles">
                <button class="welcome-tile" data-action="new" type="button">
                    <span class="icon-material" aria-hidden="true">add</span>
                    <span class="welcome-tile-label">New canvas</span>
                </button>
                <button class="welcome-tile" data-action="open" type="button">
                    <span class="icon-material" aria-hidden="true">add_photo_alternate</span>
            ...
            <div class="welcome-footer">
                ...
                <button class="action-btn welcome-close" type="button">
                    <span class="icon-material" aria-hidden="true">close</span>
                    <span>Close</span>
                </button>
            </div>
        `
