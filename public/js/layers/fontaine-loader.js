...
class FontaineLoader {
     ...
     * Prefers non-italic woff2, then any woff2, then a non-italic variable
     * ttf/otf, then any non-italic ttf/otf, then non-italic woff, then the
     * first file as a last resort.
